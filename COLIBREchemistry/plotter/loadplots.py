...
def loadAbundancePlots(
    ...
    for i in range(num_sims):
        ...
        caption += "Distribution of stars in the [C/Fe] vs [Fe/H] plane as a function of galactocentric (cilindrical) radius (R, columns) "
        caption += "and azimuthal distance (z, rows). The red contour shows the simulation data whereas the blue contour corresponds to the "
        caption += "APOGEE data distribution. "
        caption += "Contours are constructed from histogram of star counts "
        caption += "using a linear scale with a minimum star count of 10."
        filename = "CFe_comparison_radial_cut_"+name_list[i]+".png"
    ...
    for i in range(num_sims):
        ...
        caption += "Distribution of stars in the [N/Fe] vs [Fe/H] plane as a function of galactocentric (cilindrical) radius (R, columns) "
        caption += "and azimuthal distance (z, rows). The red contour shows the simulation data whereas the blue contour corresponds to the "
        caption += "APOGEE data distribution. "
        caption += "Contours are constructed from histogram of star counts "
        caption += "using a linear scale with a minimum star count of 10."
        filename = "NFe_comparison_radial_cut_" + name_list[i] + ".png"
    ...
    for i in range(num_sims):
        ...
        caption += "Distribution of stars in the [Mg/Fe] vs [Fe/H] plane as a function of galactocentric (cilindrical) radius (R, columns) "
        caption += "and azimuthal distance (z, rows). The red contour shows the simulation data whereas the blue contour corresponds to the "
        caption += "APOGEE data distribution. "
        caption += "Contours are constructed from histogram of star counts "
        caption += "using a linear scale with a minimum star count of 10."
        filename = "MgFe_comparison_radial_cut_" + name_list[i] + ".png"
    ...
    for i in range(num_sims):
        ...
        caption += "Distribution of stars in the [O/Fe] vs [Fe/H] plane as a function of galactocentric (cilindrical) radius (R, columns) "
        caption += "and azimuthal distance (z, rows). The red contour shows the simulation data whereas the blue contour corresponds to the "
        caption += "APOGEE data distribution. "
        caption += "Contours are constructed from histogram of star counts "
        caption += "using a linear scale with a minimum star count of 10."

        filename = "OFe_comparison_radial_cut_" + name_list[i] + ".png"
